...
class ZigZagSampler(Sampler):
    ...
    # Mutable state snapshotted for resume (see Sampler.state_dict). Thinning-
    # only attributes (_eval_times, _times_all) are skipped when absent.
    _CHECKPOINT_ATTRS = (
        ...
        'offset', '_s', '_eval_times', '_times_all',
    )
