...
def plot_rates_and_events(times: ndarray, rates: ndarray, f_lambda_max: Callable[[ndarray], ndarray],
                          events: ndarray, events_accepted: ndarray, upper_bound: str, plot_path: str,
